...
(function($){
	...
	var MonthView =(function($){
	   ...
	   '<div class="mc-toolbar">'+
        ...
        var dateReq = date.getFullYear() + '-' + (date.getMonth() + 1) + '-' + date.getDate();
		...
		var changeDate = function(date){
			  date && date.setHours(0,0,0,0)
				...
				$("#mc-date-label")[0].innerHTML = date_selected.getFullYear() + '-' + (date_selected.getMonth()+1) +'-' + (date_selected.getDate());
